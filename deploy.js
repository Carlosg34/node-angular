...
function cloneRepo() {
    ...
    cmd.get(
        'rm -rf node-angular && git clone https://github.com/carlosg34/node-angular.git',
...
function transferProjectToRemote(failed, successful) {
    return ssh.putDirectory(__dirname + '/node-angular', '/home/ubuntu/node-angular-temp', {
        recursive: true,
        concurrency: 1,
...
function createRemoteTempFolder() {
    return ssh.execCommand('rm -rf node-angular && mkdir node-angular-temp', {
        cwd: '/home/ubuntu'
    })
}
...
function updateRemoteApp() {
    return ssh.execCommand('cp -r node-angular/* node-angular/ && rm -rf node-angular-temp/*', {
        cwd: '/home/ubuntu'
    })
}
...
function sshConnect() {
    ...
    ssh.connect({
        ...
        .then(function() {
            ...
            console.log("Creating `node-angular` folder.");
